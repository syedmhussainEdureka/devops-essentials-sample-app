...
set wkspDIR=.\
set bldDIR="C:\Temp\J0015_Sensor_FPGA\cov-build"
...
set cmdOPT6=-source
set cmdOPT7=-notrace
set vidCMD=%vivdEXE% -log d2s_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Batch_mode.tcl -notrace
cls

cd C:\DAIRCM\BUILDS\J0015_Sensor_FPGA\%rlsNUM%\d2s_top
