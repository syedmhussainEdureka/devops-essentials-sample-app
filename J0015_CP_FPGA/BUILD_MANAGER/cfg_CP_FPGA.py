...
if OS=="nt":
 ...
 swpCMD=("fart -q " + projBASE + "\\Batch_mode.tcl 1400  " + ReleaseNum)
 xcpCMD=("xcopy /S /Q /I " + projBASE + "\\..\\" + ReleaseNum + " X:\\BUILDS\\J0015_CP_FPGA\\" + ReleaseNum +  ">NUL")
 cp="copy "
...
svnLST='svn ls'
svnINFO='svn info'
svnREPO='https://davms120131.core.drs.master/svn/J0015_CP_FPGA/'
