...
:: CP_FPGA_CSCI 
 if "%2"=="D" (set SVNDIR=J0015_CP_FPGA/trunk_2132_TEKLA/asp_fpga/)
::
:: LW CPLD CSCI: **************
:: if "%2"=="D" (set SVNDIR=J0015_Sensor_CPLD/tags/Sensor_CPLD_2132/)
::
:: PS CP_CPLD:
...
::
:: Sensor_FPGA_CSCI: ******
:: if "%2"=="D" (set SVNDIR=J0015_Sensor_FPGA/tags/D2S_FPGA_2132/d2s_top/)
::
:: Sensor_SW 
