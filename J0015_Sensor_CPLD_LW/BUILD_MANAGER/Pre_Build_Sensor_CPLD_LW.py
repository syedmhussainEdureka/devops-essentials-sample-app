#!/usr/bin/python
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## 	Name of File: Pre_Build_CPLD_LW.py
##
...
CpyFrm=("C:\\DAIRCM\\BUILDS\\J0015_Sensor_CPLD_PS\\BUILD_MANAGER\\Lattice_Build_CMD_Full.bat")
...
def helpme():
 """++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	the source for Sensor_CPLD from the SVN REPO
	...
	Example:
	Pre_Build_Sensor_CPLD_LW.py -> ReleaseNUM Debug Skip
	Pre_Build_Sensor_CPLD_LW.py -> 1400         D    S
...
##+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## Import the Source from Sensor_CPLD from SVN_Repo
##+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
def svnIMPORT():
...
svnREPO='https://davms120131.core.drs.master/svn/J0015_Sensor_CPLD/tags/Sensor_CPLD_' + ReleaseNum
