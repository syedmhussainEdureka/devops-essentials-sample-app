@echo off & setlocal
:: +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
:: 	Name of File: ChkCSCI.bat
::
:: 	Ver: 0.1	Date:04/29/2018
::
...
:STRT
:: +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
:: Check OUT The Inputs on Screen for Validation
:: +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
:loop
:: echo Checking For: !SVNDIRA[%i%]! File:!SBCFiles[%j%]!
...
echo ::		OFP. It is meant to see if all the 7 CSCI have been checked/Tagged into the SVN REPO
echo ::		 
...
set SVNLST=svn ls -R 
set LSTCMD1="%SVNLST%%SVNREPO_PATH%%SVNDIR% |Findstr ".%flExt%" >%i%_lst_%knt%.log 2>&1"
...
%DBG% echo.
  ...
  %DBG% echo FLNM: %flnme%
  echo Checking For: !SVNDIRA[%i%]! 			File: %flnme%
