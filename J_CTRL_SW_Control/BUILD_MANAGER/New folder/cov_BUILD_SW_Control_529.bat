...
echo WKS: %wkspDIR%
cd %wkspDIR%
echo %covEXE%\cov-build.exe" --no-log-server --dir %bldDIR% C:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.buildType full -ccs.configuration Debug -ccs.autoImport
%covEXE%\cov-build.exe" --no-log-server --dir %bldDIR% C:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.buildType full -ccs.configuration Debug -ccs.autoImport 
