...
set projDMY=%~1
set bldDIR="C:\Temp\%CSCI%\cov-build"\%projDMY%
echo %covexe%\cov-commit-defects.exe" --dir %bldDIR% --host coverity.core.drs.master --port 8009 --user coverity --password system --stream CM_DAIRCM_J0015_Sensor_OMAP
%covexe%\cov-commit-defects.exe" --dir %bldDIR% --host coverity.core.drs.master --port 8009 --user coverity --password system --stream CM_DAIRCM_J0015_Sensor_OMAP
echo E:%ERRORLEVEL%
