#!/usr/bin/python
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## 	Name of File: Pre_Build_Sensor_OMAP.py
##
## 	Ver: 0.1	Date:04/25/2019
##
...
## cfg_Sensor_OMAP.py is the Config File where all the common stuff for Sensor_OMAPis defined
...
svnREPO='https://davms120131.core.drs.master/svn/J0015_Sensor_OMAP' +  '/' + sys.argv[2] +  '/' + ReleaseNum
