...
:: +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
:: 	Name of File: cov_BUILD_Sensor_OMAP.bat
::
...
echo WKS: %wkspDIR%
cd %wkspDIR%
echo %covEXE%\cov-build.exe" --no-log-server --config %covCFG% --dir %bldDIR%  c:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.clean -ccs.configuration Release -ccs.autoImport
%covEXE%\cov-build.exe" --no-log-server --config %covCFG% --dir %bldDIR%  C:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.clean -ccs.configuration Release -ccs.autoImport 
...
echo WKS: %wkspDIR%
cd %wkspDIR%
echo %covEXE%\cov-build.exe" --no-log-server --config %covCFG% --dir %bldDIR% C:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.buildType full -ccs.configuration Release -ccs.autoImport
%covEXE%\cov-build.exe" --no-log-server --config %covCFG% --dir %bldDIR% C:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.buildType full -ccs.configuration Release -ccs.autoImport 
:: %covEXE%\cov-build.exe" --add-arg --c99 --delete-stale-tus --return-emit-failures --fs-capture-search  --dir %bldDIR% C:\ti\ccsv5\eclipse\eclipsec -noSplash -data %wkspDIR% -application com.ti.ccstudio.apps.projectBuild -ccs.projects %projDMY% -ccs.buildType full -ccs.configuration Release -ccs.autoImport 
